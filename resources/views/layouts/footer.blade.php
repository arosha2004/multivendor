<footer class="bg-white border-t border-gray-200 mt-auto">
    <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <!-- Customer Care -->
            <div>
                <h3 class="text-sm font-bold text-gray-900 tracking-wider uppercase mb-4">Customer Care</h3>
                <ul class="space-y-3">
                    <li><a href="#" class="text-sm text-gray-500 hover:text-blue-600 transition">Help Center</a></li>
                    <li><a href="#" class="text-sm text-gray-500 hover:text-blue-600 transition">How to Buy</a></li>
                    <li><a href="#" class="text-sm text-gray-500 hover:text-blue-600 transition">Track Your Order</a></li>
                    <li><a href="#" class="text-sm text-gray-500 hover:text-blue-600 transition">Corporate & Bulk Purchasing</a></li>
                    <li><a href="#" class="text-sm text-gray-500 hover:text-blue-600 transition">Returns & Refunds</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="mt-6">
                    <h4 class="text-xs font-bold text-gray-900 mb-2 uppercase">Payment Methods</h4>
                    <div class="flex flex-wrap gap-2 mt-2">
                        <!-- Mastercard -->
                        <div class="bg-white rounded flex items-center justify-center relative shrink-0 overflow-hidden" style="width: 42px; height: 26px; border: 1px solid #e5e7eb; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
                            <div class="rounded-full absolute left-1 z-10 mix-blend-multiply" style="width: 16px; height: 16px; background-color: #EB001B; opacity: 0.9;"></div>
                            <div class="rounded-full absolute right-1 z-20 mix-blend-multiply" style="width: 16px; height: 16px; background-color: #F79E1B; opacity: 0.9;"></div>
                        </div>
                        <!-- Visa -->
                        <div class="rounded flex items-center justify-center shrink-0" style="width: 42px; height: 26px; background-color: #1434CB;">
                            <span class="font-bold text-white italic tracking-wider" style="font-size: 11px;">VISA</span>
                        </div>

                        <!-- Amex -->
                        <div class="rounded flex flex-col items-center justify-center shrink-0" style="width: 42px; height: 26px; background-color: #006FCF;">
                            <span class="text-white font-bold text-center tracking-wide" style="font-size: 8px; line-height: 8px;">AM</span>
                            <span class="text-white font-bold text-center tracking-wide" style="font-size: 8px; line-height: 8px;">EX</span>
                        </div>
                        <!-- Cash -->
                        <div class="bg-white rounded flex items-center justify-center shrink-0" style="width: 42px; height: 26px; border: 1.5px solid #549E4A;">
                            <span class="font-bold" style="font-size: 9px; color: #549E4A;">CASH</span>
                        </div>
                    </div>
                </div>
            </div>
